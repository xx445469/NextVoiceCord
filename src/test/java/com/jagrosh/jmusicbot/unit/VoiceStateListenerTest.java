...
@DisplayName("VoiceStateListener Tests")
public class VoiceStateListenerTest {
    ...
    void setUp() {
        ...
        listener = new VoiceStateListener(fixture.getBot());
    }
    ...
    class OnGuildVoiceUpdateTests {
        @Test
        @DisplayName("delegates to AloneInVoiceHandler")
