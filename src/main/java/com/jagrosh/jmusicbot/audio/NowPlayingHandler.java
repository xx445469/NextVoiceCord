...
public class NowPlayingHandler
{
    ...
    private void reconcile(long guildId, long reconcileVersion)
    {
        ...
        GuildMessageChannel tc = guild.getChannelById(GuildMessageChannel.class, loc.channelId());
        if (tc == null)
        {
            synchronized (state)
            {
                                    ...
                                    MessageCreateData msg, long reconcileVersion)
    {
        ...
        if(previousLocation == null)
        {
            if (currentTrack.getUserData(RequestMetadata.class) != null)
            {
                ...
                tc = guild.getChannelById(GuildMessageChannel.class, channelId);
            }
            else
            {
                tc = null;
        ...
        {
            tc = guild.getChannelById(GuildMessageChannel.class, previousLocation.channelId());
        }
